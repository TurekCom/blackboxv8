...
OutputBaseFilename=BlackBoxSapi5-{#AppVersion}-dual
Compression=lzma2
...
[UninstallDelete]
Type: files; Name: "{app}\runtime\blackbox_core.py"
Type: files; Name: "{app}\runtime\blackbox_sapi_bridge.py"
Type: filesandordirs; Name: "{app}\runtime"
...
Filename: "{syswow64}\regsvr32.exe"; Parameters: "/s ""{app}\x86\{#EngineDllName32}"""; Flags: runhidden waituntilterminated

[UninstallRun]
Filename: "{sys}\regsvr32.exe"; Parameters: "/u /s ""{app}\x64\{#EngineDllName64}"""; Flags: runhidden waituntilterminated
Filename: "{syswow64}\regsvr32.exe"; Parameters: "/u /s ""{app}\x86\{#EngineDllName32}"""; Flags: runhidden waituntilterminated
...
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: ""; ValueData: "BlackBox V8 (SAPI5 x86)"; Flags: uninsdeletekey
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "CLSID"; ValueData: "{#VoiceClsid}"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "409"; ValueData: "BlackBox V8"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}\Attributes"; ValueType: string; ValueName: "Name"; ValueData: "BlackBox V8"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}\Attributes"; ValueType: string; ValueName: "Gender"; ValueData: "Male"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}\Attributes"; ValueType: string; ValueName: "Age"; ValueData: "Adult"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}\Attributes"; ValueType: string; ValueName: "Language"; ValueData: "0415"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}\Attributes"; ValueType: string; ValueName: "Vendor"; ValueData: "BlackBox"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "IntonationMode"; ValueData: "auto"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: dword; ValueName: "IntonationStrength"; ValueData: "110"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "SymbolLevel"; ValueData: "most"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "NumberMode"; ValueData: "cardinal"
Root: HKLM32; Subkey: "SOFTWARE\Microsoft\Speech\Voices\Tokens\{#VoiceToken}"; ValueType: string; ValueName: "VoiceFlavor"; ValueData: "c64"
...
begin
  ...
  begin
    ...
    RegDeleteKeyIncludingSubkeys(HKLM32, 'SOFTWARE\\Microsoft\\Speech\\Voices\\Tokens\\{#VoiceToken}');
  end;
end;
